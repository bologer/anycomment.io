	...
	class AnyCommentIntegrationSettings extends AnyCommentAdminOptions {
		...
		public function init_options() {
			...
			$integrations[] = [
				...
				'type'        => 'text',
				'description' => sprintf( __( 'reCAPTCHA site key. Can be found <a href="%s">here</a> (register your website if does not exist). Please note that you should choose "Invisible" type in order for it to work.', "anycomment" ), "http://www.google.com/recaptcha/admin" )
			];
