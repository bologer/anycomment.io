...
class AnyCommentUploadedFilesTable extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$table = AnyCommentUploadedFiles::tableName();


		$countQuery = "SELECT COUNT(*) FROM $table";
		$count      = AnyCommentUploadedFiles::find()->get_var( $countQuery );
		...
		$items = AnyCommentUploadedFiles::find()->get_results( $query, 'ARRAY_A' );
